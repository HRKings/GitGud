...
**Disclaimer:** This guide use the [Commit Guide](../Git/Commit.md) and the [Pull Request Guide](../Git/Pull_Request.md) from GitGud. Use them as a base anytime it references any of these two features.
